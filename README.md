# La Chronique des huit preuves — PWA V3
...
Remplacez les anciens fichiers par ceux de cette V3, puis validez les changements dans GitHub. Le service worker utilise un nouveau nom de cache (`huit-preuves-v3.0.0`). Après le redéploiement, rechargez une fois la page avec une connexion active.
